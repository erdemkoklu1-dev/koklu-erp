    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Kanal */}
          <div>
            <div className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Gönderim Kanalı</div>
          ...
          {/* Mesaj */}
          <div>
            <div className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Mesaj</div>
            <textarea
              value={mesaj}
