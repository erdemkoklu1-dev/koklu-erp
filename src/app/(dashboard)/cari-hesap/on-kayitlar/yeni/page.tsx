  ...
  return (
    <div className="p-6 max-w-3xl mx-auto space-y-5">
      <div className="flex items-center gap-3">
        ...
        <h2 className="text-base font-semibold text-gray-900">Yeni Ön Kayıt</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-white border rounded-xl p-5 space-y-4">
          <h3 className="text-sm font-semibold text-gray-900 pb-2 border-b">Genel Bilgiler</h3>
        ...
        <div className="bg-white border rounded-xl overflow-hidden">
          <div className="px-5 py-3 border-b bg-gray-50 flex items-center justify-between">
            <h3 className="text-sm font-semibold text-gray-900">Ürün / Hizmet Kalemleri</h3>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="text-left px-3 py-2 text-xs font-semibold text-gray-500 w-24">Miktar</th>
                  <th className="text-left px-3 py-2 text-xs font-semibold text-gray-500 w-24">Birim</th>
                  <th className="text-left px-3 py-2 text-xs font-semibold text-gray-500 w-32">Birim Fiyat</th>
