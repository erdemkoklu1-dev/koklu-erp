        ...
        <div className="bg-white border rounded-lg overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">FORM NO</th>
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">MÜŞTERİ</th>
                <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">TEKNİSYEN</th>
