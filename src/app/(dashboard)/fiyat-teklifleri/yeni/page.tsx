  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b px-6 py-4 flex items-center gap-3 sticky top-0 z-10">
        ...
        <h1 className="text-lg font-bold text-gray-900">Yeni Teklif</h1>
      </div>
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-3">
            <div className="space-y-3">
              <div>
                ...
                <input value={teklif_no} readOnly className="mt-1 w-full border rounded-lg px-3 py-2 text-sm bg-gray-50 font-mono text-gray-700 focus:outline-none" />
              </div>
              <div>
