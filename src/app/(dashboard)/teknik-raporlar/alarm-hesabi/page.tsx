...
export default async function AlarmHesabiPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-700">
      <div className="no-print border-b bg-white px-6 py-4 dark:border-gray-700 dark:bg-gray-800">
        ...
        <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">Yangın Alarm Sistemi İhtiyaç Hesabı</h1>
      </div>
      <TechnicalReportTabs active="/teknik-raporlar/alarm-hesabi" />
      <main className="p-6"><TechnicalReportForm initialType="yangin_alarm_ihtiyac" customers={customers ?? []} subeler={subeler ?? []} personeller={personeller ?? []} settings={settings ?? []} /></main>
    </div>
  )
}
