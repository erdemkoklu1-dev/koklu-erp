...
export default async function GenelIhtiyacPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-700">
      <div className="no-print border-b bg-white px-6 py-4 dark:border-gray-700 dark:bg-gray-800">
        ...
        <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">Genel Keşif ve İhtiyaç Listesi Raporu</h1>
      </div>
      <TechnicalReportTabs active="/teknik-raporlar/genel-ihtiyac" />
      <main className="p-6"><TechnicalReportForm initialType="genel_ihtiyac_raporu" customers={customers ?? []} subeler={subeler ?? []} personeller={personeller ?? []} settings={settings ?? []} /></main>
    </div>
  )
}
