...
export default function OperationFilters({ action, subeler, values, durumlar, searchPlaceholder = 'Ara' }: Props) {
  return (
    <form action={action} className="no-print grid gap-3 rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-800 md:grid-cols-6">
      ...
      />
      <select name="sube" defaultValue={values.sube ?? ''} className="rounded-md border px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900">
