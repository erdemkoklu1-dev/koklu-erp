    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 max-w-xl mx-auto space-y-4">
        ...
        <div className="bg-white border rounded-lg p-4 flex items-center justify-between">
          ...
          {sonGiris && (
            <div className="text-right">
              <div className="text-xs text-gray-500 mb-1">Önceki Giriş</div>
              <div className="text-sm text-gray-700">{fmt(sonGiris.created_at)}</div>
              {sonGiris.ip_adresi && <div className="text-xs text-gray-400 font-mono">{sonGiris.ip_adresi}</div>}
            </div>
          )}
        </div>
        ...
        <div className="bg-white border rounded-lg p-5">
          <h2 className="text-sm font-semibold text-gray-700 mb-4 pb-2 border-b">Profil Bilgileri</h2>
          <form onSubmit={handleProfilKaydet} className="space-y-3">
            <div>
              <label className="text-xs font-medium text-gray-600">Email</label>
              <input value={email} readOnly className="mt-1 w-full border rounded-lg px-3 py-2 text-sm bg-gray-50 text-gray-500 focus:outline-none" />
            </div>
            <div>
        ...
        {/* Şifre Değiştir */}
        <div className="bg-white border rounded-lg p-5">
          <h2 className="text-sm font-semibold text-gray-700 mb-4 pb-2 border-b">Şifre Değiştir</h2>
