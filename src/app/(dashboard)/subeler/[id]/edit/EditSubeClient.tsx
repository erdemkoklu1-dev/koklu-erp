  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-700">
      <div className="bg-white dark:bg-gray-800 border-b px-6 py-4 flex items-center gap-3">
        ...
        <Link href={`/subeler/${sube.id}`} className="text-gray-500 dark:text-gray-400 hover:text-gray-700 text-sm">← {sube.ad}</Link>
        <span className="text-gray-300">/</span>
        <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">Düzenle</h1>
      </div>
      <div className="p-6 max-w-2xl mx-auto">
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 border rounded-xl p-6 space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Link href={`/subeler/${sube.id}`} className="px-6 py-2 border rounded-lg text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 text-center">İptal</Link>
          </div>
        </form>
      </div>
    </div>
