...
export default async function BekleyenlerPage({ searchParams }: { searchParams: Promise<{ sube?: string }> }) {
  ...
  return (
    <div className="space-y-5 p-6">
      <h1 className="text-xl font-bold">Geri teslim bekleyenler</h1>
