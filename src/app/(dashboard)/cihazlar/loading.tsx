export default function CihazlarLoading() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-700 animate-pulse">
      ...
      <div className="p-6 space-y-5">
        <div className="grid grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-white dark:bg-gray-800 border rounded-xl p-4 space-y-2">
        ...
        <div className="bg-white dark:bg-gray-800 border rounded-xl overflow-hidden">
          {[...Array(8)].map((_, i) => (
            <div key={i} className="flex gap-4 px-4 py-4 border-b last:border-0">
              <div className="h-4 w-48 bg-gray-100 dark:bg-gray-700 rounded flex-1" />
