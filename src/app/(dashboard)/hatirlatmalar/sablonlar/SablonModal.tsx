                ...
                <div className="flex flex-wrap gap-1.5 mb-2">
                  {DEGISKENLER.map(d => (
                    <button
                      ...
                      title={d.aciklama}
                      className="text-xs bg-gray-100 text-gray-600 border border-gray-200 px-2 py-0.5 rounded hover:bg-[#C8102E] hover:text-white hover:border-[#C8102E] transition-colors"
                    >
                      {d.key}
                    </button>
                  ))}
