    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white border rounded-lg p-4">
          ...
          <div className="text-2xl font-bold text-gray-900 mt-1">{toplamKullanici}</div>
        </div>
      ...
      <div className="bg-white border rounded-lg p-5">
        <h3 className="text-sm font-semibold text-gray-700 mb-4">Role Göre Kullanıcı Dağılımı</h3>
        <div className="space-y-3">
          {rolSirali.map(r => (
            <div key={r.ad} className="flex items-center gap-3">
              <div className="w-28 text-sm text-gray-700 truncate">{r.ad}</div>
              ...
              <div className="w-8 text-sm font-bold text-gray-700 text-right">{r.sayi}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Bu ay özet */}
      <div className="bg-white border rounded-lg p-5">
        <h3 className="text-sm font-semibold text-gray-700 mb-4">Bu Ay İşlem Özeti</h3>
